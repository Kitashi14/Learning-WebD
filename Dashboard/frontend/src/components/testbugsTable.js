...
// table heads
export default function TestbugsMetricsTable(props) {
  const TABLE_HEAD = [
    "Bug ID",
    "Headline",
    "State",
                ...
                <>
                  <td className="p-4">
                    <Typography
                      ...
                      onClick={() => {
                        if (
                          contextData.testbugs_currentUser !==
                          data.assigned_under
                        ) {
                          contextData.setIsTestbugsPageLoading(true);
                          navigate(`/testbugs/view/${data.assigned_under}`);
                        }
                      }}
                    >
                      {data.assigned_under}
                ...
                <Typography
                  ...
                  onClick={() => {
                    if (
                      ...
                      contextData.setIsTestbugsPageLoading(true);
                      navigate(`/testbugs/view/${data.mgr_id}`);
                    }
                  }}
                >
                  {data.mgr_id}
